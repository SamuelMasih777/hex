...
export default function BelowSection(){
    return(
        ...
        <div className="p-6 px-2">
          ...
          <span class="material-symbols-outlined justify-center items-center fill-current text-blue-500">arrow_back_ios</span>
            ...
            <span class=" material-symbols-outlined justify-center align-center fill-current text-blue-500">arrow_forward_ios</span>
          </div>
        </div>
      </div>
    )
